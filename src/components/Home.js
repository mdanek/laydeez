...
const Home = ({ active, handleToggleMenu, mobile }) => {
    ...
    return (
        <div id="home" className={`${styles.home} page`}>
            ...
            <video className={styles.homevideo} src={mobile ? homevideoMob : homevideo} poster={mobile ? homevideoposterMob : homevideoposter} muted autoPlay={"autoplay"} preLoad="auto" loop />
